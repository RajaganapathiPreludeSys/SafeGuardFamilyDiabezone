...
class LinePagerIndicatorDecoration(baseContext: Context) : ItemDecoration() {

    private val colorActive = baseContext.getColor(R.color.blue)
    private val colorInactive = baseContext.getColor(R.color.white)
     ...
     * Indicator width.
     */
    private val mIndicatorItemLength = DP * 25
