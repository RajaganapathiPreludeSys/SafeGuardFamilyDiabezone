package com.safeguardFamily.diabezone.ui.graph.animation;
...
import com.safeguardFamily.diabezone.ui.graph.draw.data.DrawData;
...
public class AnimationManager {
    ...
    private ValueAnimator createAnimator(@NonNull DrawData drawData) {
        ...
        animator.addUpdateListener(AnimationManager.this::onAnimationUpdate);
